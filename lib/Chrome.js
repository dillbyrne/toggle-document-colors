...
branch = Services.prefs.getBranch("browser.display.document_color_use");
...
exports.onUnload = function(reason) {
    ...
    if(reason == "disable" || reason == "uninstall"){
        ...
        PrefServ.resetter("browser.display.document_color_use");
        PrefServ.resetter("browser.display.use_system_colors");
    }
};
