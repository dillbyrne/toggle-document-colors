...
function toggleDocumentColors(){
	...
	if(PrefServ.getter("browser.display.document_color_use") == 0){
		PrefServ.setter("browser.display.document_color_use",2);
		PrefServ.setter("browser.display.use_system_colors",false);
	
	}else{
    	PrefServ.setter("browser.display.document_color_use",0);
		PrefServ.setter("browser.display.use_system_colors",true);
	}
};
